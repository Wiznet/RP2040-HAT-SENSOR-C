...
if(NOT Git_FOUND)
	message(FATAL_ERROR "Could not find 'git' tool for RP2040-HAT-SENSOR-C patching")
endif()

message("RP2040-HAT-SENSOR-C patch utils found")

set(RP2040_HAT_SENSOR_C_SRC_DIR "${CMAKE_CURRENT_SOURCE_DIR}")
set(FREERTOS_KERNEL_SRC_DIR "${RP2040_HAT_SENSOR_C_SRC_DIR}/libraries/FreeRTOS-Kernel")
set(IOLIBRARY_DRIVER_SRC_DIR "${RP2040_HAT_SENSOR_C_SRC_DIR}/libraries/ioLibrary_Driver")
set(MBEDTLS_SRC_DIR "${RP2040_HAT_SENSOR_C_SRC_DIR}/libraries/mbedtls")
set(PICO_EXTRAS_SRC_DIR "${RP2040_HAT_SENSOR_C_SRC_DIR}/libraries/pico-extras")
set(PICO_SDK_SRC_DIR "${RP2040_HAT_SENSOR_C_SRC_DIR}/libraries/pico-sdk")
set(PICO_SDK_TINYUSB_SRC_DIR "${RP2040_HAT_SENSOR_C_SRC_DIR}/libraries/lib/tinyusb")
set(RP2040_HAT_SENSOR_C_PATCH_DIR "${RP2040_HAT_SENSOR_C_SRC_DIR}/patches")
...
execute_process(COMMAND ${GIT_EXECUTABLE} -C ${RP2040_HAT_SENSOR_C_SRC_DIR} submodule update --init)
